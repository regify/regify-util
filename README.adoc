...
* win32
 ...
 cmake -G "NMake Makefiles" -DCMAKE_BUILD_TYPE=Release \
    -DCMAKE_SYSTEM_NAME=Windows -DBUILD_ARCH=win32 \
    -DICU_PREFIX=../../win32 \
    -DCMAKE_VERBOSE_MAKEFILE=ON  \
...
* x64
 ...
 cd build
 cmake -G "NMake Makefiles" -DCMAKE_BUILD_TYPE=Release \
    -DCMAKE_SYSTEM_NAME=Windows -DBUILD_ARCH=x64 \
    -DICU_PREFIX=../../x64 \
    -DCMAKE_VERBOSE_MAKEFILE=ON \
    -DDOCS=ON -DINCLUDE_ICU=ON -DBUILD_SHARED_LIBS=ON ..
 nmake package
...
* mingw32
 ...
 cd build
 cmake -G "Unix Makefiles" -DCMAKE_BUILD_TYPE=Release \
    -DCMAKE_SYSTEM_NAME=Windows -DBUILD_ARCH=mingw32 \
    -DICU_PREFIX=../../mingw32 \
    -DCMAKE_VERBOSE_MAKEFILE=ON \
    -DDOCS=ON -DINCLUDE_ICU=ON -DBUILD_SHARED_LIBS=ON ..
 make package
...
* mingw64
 ...
 cd build
 cmake -G "Unix Makefiles" -DCMAKE_BUILD_TYPE=Release \
    -DCMAKE_SYSTEM_NAME=Windows -DBUILD_ARCH=mingw64 \
    -DICU_PREFIX=../../mingw64 \
    -DCMAKE_VERBOSE_MAKEFILE=ON \
    -DDOCS=ON -DINCLUDE_ICU=ON -DBUILD_SHARED_LIBS=ON ..
 make package
...
* armv7
 ...
 cmake -DCMAKE_VERBOSE_MAKEFILE=ON -DCMAKE_BUILD_TYPE=Release \
    ...
    -DBUILD_ARCH=armv7 -DCMAKE_SYSTEM_NAME=Android \
...
* arm64
 ...
 cmake -DCMAKE_VERBOSE_MAKEFILE=ON -DCMAKE_BUILD_TYPE=Release \
    -DCMAKE_TOOLCHAIN_FILE=/path/to/ndk/build/cmake/android.toolchain.cmake \
    -DBUILD_ARCH=arm64 -DCMAKE_SYSTEM_NAME=Android \
...
For OS X only x86_64 is currently supported.
 ...
 cd build
 cmake -DCMAKE_VERBOSE_MAKEFILE=ON -DCMAKE_BUILD_TYPE=Release \
    -DCMAKE_SYSTEM_NAME=Darwin -DBUILD_ARCH=x86_64 ..
 make
...
* armv7
 ...
 cd build
 cmake -DCMAKE_VERBOSE_MAKEFILE=ON -DCMAKE_BUILD_TYPE=Release \
    -G "Unix Makefiles" -DBUILD_ARCH=armv7 -DCMAKE_SYSTEM_NAME=iOS \
...
* armv7s
 ...
 cd build
 cmake -DCMAKE_VERBOSE_MAKEFILE=ON -DCMAKE_BUILD_TYPE=Release \
    -G "Unix Makefiles" -DBUILD_ARCH=armv7s -DCMAKE_SYSTEM_NAME=iOS \
...
* arm64
 ...
 cd build
 cmake -DCMAKE_VERBOSE_MAKEFILE=ON -DCMAKE_BUILD_TYPE=Release \
    -G "Unix Makefiles" -DBUILD_ARCH=arm64 -DCMAKE_SYSTEM_NAME=iOS \
